 ...
 */
package com.cloud.music.commonsdk.core;
...
public interface RouterHub {
    ...
    String FIND = "/find";//发现组件
    String SPRINKLER = "/sprinkler";//播客组件
    String MINE = "/mine";//我的组件
    String KSONG = "/ksong";//K歌组件
    String VILLAGE = "/village";//云村组件
     ...
     * 发现分组
     */
    String FIND_SERVICE_FINDINFOSERVICE = FIND + SERVICE + "/FindInfoService";

    String FIND_HOME_FRAGMENT = FIND + "/HomeFragment";
    String FIND_DETAILACTIVITY = FIND + "/DetailActivity";

    /**
     * 播客分组
     */
    String SPRINKLER_SERVICE_SPRINKLERINFOSERVICE = SPRINKLER + SERVICE + "/SprinklerInfoService";

    String SPRINKLER_HOME_FRAGMENT = SPRINKLER + "/HomeFragment";

    /**
     * 我的分组
     */
    String MINE_SERVICE_MINEINFOSERVICE = MINE + SERVICE + "/MineInfoService";

    String MINE_HOME_FRAGMENT = MINE + "/HomeFragment";

    /**
     * K歌分组
     */
    String KSONG_SERVICE_KSONGINFOSERVICE = KSONG + SERVICE + "/KSongInfoService";
    String KSONG_HOME_FRAGMENT = KSONG + "/HomeFragment";


    /**
     * 云村分组
     */
    String VILLAGE_SERVICE_VILLAGEINFOSERVICE = VILLAGE + SERVICE + "/VillageInfoService";
    String VILLAGE_HOME_FRAGMENT = VILLAGE + "/HomeFragment";
}
