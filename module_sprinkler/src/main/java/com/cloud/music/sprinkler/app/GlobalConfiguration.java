 ...
 */
package com.cloud.music.sprinkler.app;
...
import com.cloud.music.sprinkler.BuildConfig;
 ...
 * CommonSDK 中已有 {@link com.cloud.music.commonsdk.core.GlobalConfiguration} 配置有所有组件都可公用的配置信息
 * 这里用来配置一些组件自身私有的配置信息
 *
